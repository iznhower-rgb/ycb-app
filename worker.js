      ...
      try{
        ...
        const message =
          multiProviderReady
            ...
            ? "اكتمل تحليل المباراة بعد التحقق من مصدرين ناجحين على الأقل."

            : "تم تحليل المباراة، لكن مصدرين ناجحين على الأقل مطلوبان قبل إصدار رهان موصى به.";
...
function buildPredictions(
  ...
  return {
    ...
    predictedScore:
      ...
      `${analysis.model.bestScore.home}` +
      ` - ` +
      `${analysis.model.bestScore.away}`
