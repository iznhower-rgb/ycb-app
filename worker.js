// ==========================================================
// Y.C.B FINAL WORKER 3.0.0
// Two-provider verified architecture: ESPN + SofaScore
// ==========================================================
...
<div class="subtitle">
Football Prediction Engine 3.0
</div>
...
<div class="note">
التحليل لا يصدر رهانًا موصى به إلا بعد التحقق من المباراة ونجاح المصدرين معًا.
</div>
...
async function analyzeMatch(){
  ...
  status.textContent =
    "جاري التحقق من المباراة عبر ESPN و SofaScore...";
  ...
  async fetch(
    ...
    if(
      ...
      return json({
        ...
        architecture:
          "Two Provider Verified Architecture",
      ...
      try{
        ...
        if(
          ...
          return json(
            ...
            baseResponse(
              ...
              "لم يتم التحقق من المباراة المطلوبة في المصدرين."
        ...
        if(
          ...
          return json({
            ...
            ...baseResponse(
              ...
              "تم التحقق من المباراة، لكن البيانات التاريخية أقل من 3 مباريات لأحد الفريقين."
        ...
        const message =
          multiProviderReady
            ...
            ? "اكتمل تحليل المباراة بعد تحقق مستقل من ESPN و SofaScore."

            : "تم التحليل، لكن لا يوجد مصدران ناجحان؛ لذلك لا يصدر Y.C.B رهانًا موصى به.";
        ...
        if(
          ...
          recommendationMessage =
            "لا يوجد رهان موصى به: يجب نجاح مصدرين مستقلين على الأقل.";
...
function buildPredictions(
  ...
  const goalsMarket = [

    {
      ...
      explanation:
        "سوق إجمالي الأهداف وفق نموذج بواسون."
...
function baseResponse(
  ...
  return {
    ...
    recommendation: {
      ...
      message:
        "لا يوجد رهان موصى به: يجب التحقق من المباراة والبيانات عبر مصدرين مستقلين."
